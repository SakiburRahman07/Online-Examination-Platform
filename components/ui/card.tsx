...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-slate-200/50 bg-white/80 backdrop-blur-sm text-slate-950 shadow-xl dark:border-slate-800/50 dark:bg-slate-900/80 dark:text-slate-50",
      className
    )}
    {...props}
  />
